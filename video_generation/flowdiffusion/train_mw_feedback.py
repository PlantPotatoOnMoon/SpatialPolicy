from goal_diffusion_feedback import GoalGaussianDiffusion, Trainer
from unet import UnetMW as Unet
from transformers import CLIPTextModel, CLIPTokenizer
from datasets_feedback import SequentialDatasetv2, parse_feedback_plan
...
def main(args):
    ...
    if args.mode == 'inference':
        ...
        train_set = SequentialDatasetv2(
            ...
            path="/villa/VideoAgent_exp/dataset/high_quality_diff/recover300_20/fine_prob/", 
    ...
    if args.mode == 'train':
        ...
        if args.batch_mode:
            ...
            inference_dataset = SequentialDatasetv2(
                sample_per_seq=sample_per_seq, 
                path="/villa/VideoAgent_exp/dataset/high_quality_diff/recover300_20/fine_prob/assembly-v2-goal-observable/", 
                target_size=target_size,
                randomcrop=False  
            )
