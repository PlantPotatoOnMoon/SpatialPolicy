from goal_diffusion_thor_ourdataset_feedback import GoalGaussianDiffusion, Trainer
from unet import UnetThor as Unet
from transformers import CLIPTextModel, CLIPTokenizer
from datasets_thor_ourdataset_feedback import SequentialNavDataset, SequentialGifDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument('-proc_id', type=str, default='3001', help='Process ID for logging') # add proc_id parameter
